...
public class MateriaServiceImpl implements IMateriaService {
    ...
    private MateriaDTO mapToDTO(Materia materia) {
        ...
        MateriaDTO.MateriaDTOBuilder builder = MateriaDTO.builder()
                .id(materia.getId())
        ...
        // Agrega información del docente si existe
        if (materia.getDocente() != null) {
            builder.docenteId(materia.getDocente().getId());
            builder.docenteNombre(materia.getDocente().getNombre() + " " + materia.getDocente().getApellido());
        }
    ...
    @Override
    public Materia obtenerEntidadMateriaPorId(Long id) {
        return materiaRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Materia no encontrada con id: " + id));
    }

    @Override
    public Materia guardarEntidad(Materia materia) {
